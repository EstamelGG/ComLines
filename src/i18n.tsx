      ...
      en: {
        translation: {
          ...
          functionLinks: [
            ...
            {'title': 'Cmd Confusion', 'link': '../CmdConfusion'},
          ...
          cmd_confusion: 'Commandline Obfuscator',
          cmd_confusion_desc: 'Commandline Obfuscator is used to edit command line and confuse EDR devices.',
          quotation: 'quotation',
          Carets: 'Carets',
          variable: 'variable',
      ...
      zh: {
        translation: {
          ...
          functionLinks: [
            ...
            {'title': 'Oneliner', 'link': '../OneLiner'},
            {'title': 'Cmd 混淆器', 'link': '../CmdConfusion'},
          ...
          cmd_confusion: '命令行混淆器',
          cmd_confusion_desc: '本页提供了一个用于混淆命令行的工具，以降低 EDR 等设备检测到命令行中关键词的概率。混淆方案包括：${IFS}、转义、引号、tab、变量。注意：不保证总能正常执行。',
          quotation: '引号',
          Carets: '脱字符(^)',
          variable: '变量',
