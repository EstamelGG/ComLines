    ...
    resources: {
      ...
      zh: {
        translation: {
          ...
          revshell_desc: '反弹 shell 一般是指 "由受害主机反向向攻击者主机建立网络连接，使攻击者能够通过网络在受害主机上操作 Shell" 的行为。<br />通常是通过利用受害主机中的软件漏洞，或诱使受害者运行后门程序以建立反弹 Shell。<br />以下部分命令提供了基于各种编码的单行命令行 (OneLiner)。',
