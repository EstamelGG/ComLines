    ...
    resources: {
      en: {
        translation: {
          ...
          tty_solution3_getbin: 'Install Pwncat',
          tty_solution3_use: 'Use Pwncat',
          tty_solution3_shell: 'Get Remote Doamin\'s Shell',
      ...
      zh: {
        translation: {
          ...
          tty_solution1_use: '在反弹获得的 Shell 中执行',
          tty_solution2_getbin: '获取 Socat 二进制程序，在目标主机执行',
          tty_solution2_getcmd: '获取 Socat 反弹 Shell 命令行',
          tty_solution3_getbin: '安装 Pwncat',
          tty_solution3_use: '使用 Pwncat 创建监听',
          tty_solution3_shell: '进入远程主机的 Shell',
