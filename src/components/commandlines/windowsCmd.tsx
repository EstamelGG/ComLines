...
export default function WindowsCommands() {
    const { t } = useTranslation();
    let payloads = require('../../static/data/windowsCmds.json');
    document.title = `${t('windows_cmd_title')} - HackTrick Checklist`;
    return (
        <div style={{ margin: 15 }}>
            <Title level={2} style={{ fontWeight: 'bold' }}>
                {t('windows_cmd_title')}
            </Title>
            <Paragraph>{t('windows_cmd_desc')}</Paragraph>
            ...
            <div>
                ...
                <br />
                - <Link href="https://lolbas-project.github.io/" target='_blank'>LOLBAS</Link>
            </div>
            <div>
